                ...
                <h2 class="text-center">Update your personal details:</h1>
                    <form id="condos" method="POST" action="{{ url('condominium/'. $unit->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="owner" id="owner" placeholder="{{ $unit->owner }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="contact" id="contact" placeholder="{{ $unit->contact }}">
                        </div>
